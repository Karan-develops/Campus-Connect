...
CREATE TABLE "PrivacySettings" (
    ...
    "showExtracurriculars" BOOLEAN NOT NULL DEFAULT true,
...
-- AddForeignKey
ALTER TABLE "Extracurricular" ADD CONSTRAINT "Extracurricular_userId_fkey" FOREIGN KEY ("userId") REFERENCES "User"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
